...
<div class="content-3-5 d-flex flex-column align-items-center h-100 flex-lg-row" style="font-family: 'Poppins', sans-serif; background:#559eff;">
  ...
  <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0" style=" background:#559eff;">
    <div class="right mx-lg-0 mx-auto">
      ...
      <h3 class="title-text" style="color: white;">Login Admin</h3>
      ...
      <form style="margin-top: 1.5rem" action="/auth/valid_login" method="post">
        <div style=" margin-bottom: 1.75rem">
          ...
          <div class="d-flex w-100 div-input">
            ...
            <input class="input-field border-0" type="text" name="username" id="" placeholder="Masukkan Username" autocomplete="on" required />
          </div>
        </div>
        <div style="margin-top: 1rem">
          ...
          <div class="d-flex w-100 div-input">
            ...
            <input class="input-field border-0" type="password" name="password" id="password-content-3-5" placeholder="Masukkan Password" minlength="6" required />
        ...
        <button class="btn btn-primary btn-fill text-white d-block w-100" type="submit" name="login">
          Log In To My Account
        </button>
      </form>
      <p class="text-center bottom-caption">
        Kembali ke halaman utama
        <a class="white-bottom-caption" href="/">
          Home
        </a>
      </p>
    </div>
